...
//  גרסה 2.3 | תשפ"ז — שקיעה וסוזק"ש מלוח עתים לבינה
// ============================================================
...
// { 'YYYY-MM-DD': [סוזק"ש מג"א, שקיעה במישור] } — שעון ישראל, 24 שעות
const LUACH_TASHPAZ = {
  "2026-09-12": ["08:42", "18:48:45"],  // ראש השנה א׳ (שבת)
  "2026-09-13": ["08:43", "18:47:30"],  // ראש השנה ב׳
  "2026-09-19": ["08:44", "18:39:45"],  // שבת האזינו
  "2026-09-21": ["08:44", "18:37:00"],  // יום הכיפורים
  "2026-09-26": ["08:45", "18:30:30"],  // שבת - סוכות (יו"ט ראשון)
  "2026-10-03": ["08:46", "18:21:30"],  // שבת - שמיני עצרת ושמחת תורה
  "2026-10-10": ["08:47", "18:13:00"],  // שבת בראשית
  "2026-10-17": ["08:49", "18:04:45"],  // שבת נח
  "2026-10-24": ["08:51", "17:57:15"],  // שבת לך לך
  "2026-10-31": ["07:53", "16:50:30"],  // שבת וירא
  "2026-11-07": ["07:55", "16:45:00"],  // שבת חיי שרה
  "2026-11-14": ["07:58", "16:40:30"],  // שבת תולדות
  "2026-11-21": ["08:01", "16:37:30"],  // שבת ויצא
  "2026-11-28": ["08:05", "16:35:30"],  // שבת וישלח
  "2026-12-05": ["08:09", "16:35:15"],  // שבת וישב
  "2026-12-12": ["08:13", "16:36:15"],  // שבת מקץ
  "2026-12-19": ["08:17", "16:38:45"],  // שבת ויגש
  "2026-12-26": ["08:20", "16:42:30"],  // שבת ויחי
  "2027-01-02": ["08:23", "16:47:15"],  // שבת שמות
  "2027-01-09": ["08:25", "16:52:45"],  // שבת וארא
  "2027-01-16": ["08:27", "16:58:45"],  // שבת בא
  "2027-01-23": ["08:27", "17:05:00"],  // שבת בשלח
  "2027-01-30": ["08:27", "17:11:30"],  // שבת יתרו
  "2027-02-06": ["08:25", "17:17:45"],  // שבת משפטים
  "2027-02-13": ["08:23", "17:23:45"],  // שבת תרומה
  "2027-02-20": ["08:20", "17:29:45"],  // שבת תצוה
  "2027-02-27": ["08:16", "17:35:15"],  // שבת כי תשא
  "2027-03-06": ["08:11", "17:40:30"],  // שבת ויקהל
  "2027-03-13": ["08:06", "17:45:30"],  // שבת פקודי
  "2027-03-20": ["08:00", "17:50:15"],  // שבת ויקרא
  "2027-03-27": ["08:54", "18:54:45"],  // שבת צו
  "2027-04-03": ["08:48", "18:59:30"],  // שבת שמיני
  "2027-04-10": ["08:42", "19:04:15"],  // שבת תזריע
  "2027-04-17": ["08:37", "19:08:45"],  // שבת מצורע
  "2027-04-22": ["08:33", "19:12:15"],  // פסח (יו"ט ראשון)
  "2027-04-24": ["08:31", "19:13:30"],  // שבת חוה"מ פסח
  "2027-04-28": ["08:28", "19:16:30"],  // שביעי של פסח
  "2027-05-01": ["08:26", "19:18:15"],  // שבת אחרי מות
  "2027-05-08": ["08:21", "19:23:15"],  // שבת קדושים
  "2027-05-15": ["08:18", "19:28:00"],  // שבת אמור
  "2027-05-22": ["08:14", "19:32:45"],  // שבת בהר
  "2027-05-29": ["08:12", "19:37:00"],  // שבת בחוקותי
  "2027-06-05": ["08:11", "19:40:45"],  // שבת במדבר
  "2027-06-11": ["08:11", "19:43:45"],  // שבועות
  "2027-06-12": ["08:11", "19:44:00"],  // שבת נשא
  "2027-06-19": ["08:12", "19:46:15"],  // שבת בהעלותך
  "2027-06-26": ["08:13", "19:47:30"],  // שבת שלח לך
  "2027-07-03": ["08:15", "19:47:45"],  // שבת קרח
  "2027-07-10": ["08:18", "19:46:30"],  // שבת חקת
  "2027-07-17": ["08:22", "19:44:15"],  // שבת בלק
  "2027-07-24": ["08:25", "19:40:45"],  // שבת פינחס
  "2027-07-31": ["08:28", "19:36:00"],  // שבת מטות-מסעי
  "2027-08-07": ["08:31", "19:30:15"],  // שבת דברים
  "2027-08-14": ["08:34", "19:23:30"],  // שבת ואתחנן
  "2027-08-21": ["08:37", "19:16:00"],  // שבת עקב
  "2027-08-28": ["08:39", "19:08:00"],  // שבת ראה
  "2027-09-04": ["08:41", "18:59:15"],  // שבת שופטים
  "2027-09-11": ["08:42", "18:50:30"],  // שבת כי תצא
  "2027-09-18": ["08:43", "18:41:15"],  // שבת כי תבוא
  "2027-09-25": ["08:45", "18:32:00"]   // שבת נצבים-וילך
};
