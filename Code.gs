...
//  גרסה 2.3 | תשפ"ז — שקיעה וסוזק"ש (גר"א) מלוח עתים לבינה
// ============================================================
...
// ==================== לוח עתים לבינה ====================
// עתים לבינה, אופק מיצד — תשפ"ז (12.9.2026–25.9.2027)
// { 'YYYY-MM-DD': [סוזק"ש גר"א, שקיעה במישור] } — שעון ישראל, 24 שעות
const LUACH_TASHPAZ = {
  "2026-09-12": ["09:28", "18:48:45"],  // ראש השנה א׳ (שבת)
  "2026-09-13": ["09:28", "18:47:30"],  // ראש השנה ב׳
  "2026-09-19": ["09:29", "18:39:45"],  // שבת האזינו
  "2026-09-21": ["09:29", "18:37:00"],  // יום הכיפורים
  "2026-09-26": ["09:30", "18:30:30"],  // שבת - סוכות (יו"ט ראשון)
  "2026-10-03": ["09:31", "18:21:30"],  // שבת - שמיני עצרת ושמחת תורה
  "2026-10-10": ["09:32", "18:13:00"],  // שבת בראשית
  "2026-10-17": ["09:34", "18:04:45"],  // שבת נח
  "2026-10-24": ["09:36", "17:57:15"],  // שבת לך לך
  "2026-10-31": ["08:38", "16:50:30"],  // שבת וירא
  "2026-11-07": ["08:41", "16:45:00"],  // שבת חיי שרה
  "2026-11-14": ["08:44", "16:40:30"],  // שבת תולדות
  "2026-11-21": ["08:48", "16:37:30"],  // שבת ויצא
  "2026-11-28": ["08:52", "16:35:30"],  // שבת וישלח
  "2026-12-05": ["08:56", "16:35:15"],  // שבת וישב
  "2026-12-12": ["09:01", "16:36:15"],  // שבת מקץ
  "2026-12-19": ["09:04", "16:38:45"],  // שבת ויגש
  "2026-12-26": ["09:08", "16:42:30"],  // שבת ויחי
  "2027-01-02": ["09:11", "16:47:15"],  // שבת שמות
  "2027-01-09": ["09:13", "16:52:45"],  // שבת וארא
  "2027-01-16": ["09:14", "16:58:45"],  // שבת בא
  "2027-01-23": ["09:14", "17:05:00"],  // שבת בשלח
  "2027-01-30": ["09:13", "17:11:30"],  // שבת יתרו
  "2027-02-06": ["09:11", "17:17:45"],  // שבת משפטים
  "2027-02-13": ["09:08", "17:23:45"],  // שבת תרומה
  "2027-02-20": ["09:04", "17:29:45"],  // שבת תצוה
  "2027-02-27": ["09:00", "17:35:15"],  // שבת כי תשא
  "2027-03-06": ["08:55", "17:40:30"],  // שבת ויקהל
  "2027-03-13": ["08:50", "17:45:30"],  // שבת פקודי
  "2027-03-20": ["08:45", "17:50:15"],  // שבת ויקרא
  "2027-03-27": ["09:39", "18:54:45"],  // שבת צו
  "2027-04-03": ["09:34", "18:59:30"],  // שבת שמיני
  "2027-04-10": ["09:29", "19:04:15"],  // שבת תזריע
  "2027-04-17": ["09:24", "19:08:45"],  // שבת מצורע
  "2027-04-22": ["09:20", "19:12:15"],  // פסח (יו"ט ראשון)
  "2027-04-24": ["09:19", "19:13:30"],  // שבת חוה"מ פסח
  "2027-04-28": ["09:17", "19:16:30"],  // שביעי של פסח
  "2027-05-01": ["09:15", "19:18:15"],  // שבת אחרי מות
  "2027-05-08": ["09:12", "19:23:15"],  // שבת קדושים
  "2027-05-15": ["09:09", "19:28:00"],  // שבת אמור
  "2027-05-22": ["09:07", "19:32:45"],  // שבת בהר
  "2027-05-29": ["09:06", "19:37:00"],  // שבת בחוקותי
  "2027-06-05": ["09:06", "19:40:45"],  // שבת במדבר
  "2027-06-11": ["09:06", "19:43:45"],  // שבועות
  "2027-06-12": ["09:06", "19:44:00"],  // שבת נשא
  "2027-06-19": ["09:07", "19:46:15"],  // שבת בהעלותך
  "2027-06-26": ["09:09", "19:47:30"],  // שבת שלח לך
  "2027-07-03": ["09:11", "19:47:45"],  // שבת קרח
  "2027-07-10": ["09:13", "19:46:30"],  // שבת חקת
  "2027-07-17": ["09:15", "19:44:15"],  // שבת בלק
  "2027-07-24": ["09:18", "19:40:45"],  // שבת פינחס
  "2027-07-31": ["09:20", "19:36:00"],  // שבת מטות-מסעי
  "2027-08-07": ["09:22", "19:30:15"],  // שבת דברים
  "2027-08-14": ["09:23", "19:23:30"],  // שבת ואתחנן
  "2027-08-21": ["09:25", "19:16:00"],  // שבת עקב
  "2027-08-28": ["09:26", "19:08:00"],  // שבת ראה
  "2027-09-04": ["09:27", "18:59:15"],  // שבת שופטים
  "2027-09-11": ["09:28", "18:50:30"],  // שבת כי תצא
  "2027-09-18": ["09:29", "18:41:15"],  // שבת כי תבוא
  "2027-09-25": ["09:30", "18:32:00"]   // שבת נצבים-וילך
};
...
function getZmanimForShabbat() {
  ...
  // שקיעה וסוף זמן ק"ש — מלוח עתים לבינה (אופק מיצד) אם התאריך קיים בו.
  // אחרת (תאריך מחוץ ללוח) — גיבוי ל-Hebcal כמו קודם, ומייל התראה לגבאי.
  let shkia, sofZmanKsh, kshLabel, fromLuach;
  const luach = LUACH_TASHPAZ[dateStr];
  if (luach) {
    sofZmanKsh = luach[0];
    shkia      = luach[1].substring(0, 5);   // חיתוך שניות כלפי מטה (18:39:45 → 18:39)
    kshLabel   = 'גר"א';
    fromLuach  = true;
  } else {
    shkia      = subtractMinutes(parseTime(times.sunset), 1);
    sofZmanKsh = parseTime(times.sofZmanShma);
    kshLabel   = 'גר"א';
    fromLuach  = false;
    try {
      GmailApp.sendEmail(getAdminEmail(), "⚠️ זמני שבת: התאריך לא נמצא בלוח עתים לבינה",
        "השבת " + dateStr + " אינה בלוח המוטמע (LUACH_TASHPAZ).\n"
        + "הזמנים חושבו מ-Hebcal (סוף זמן ק\"ש לפי גר\"א). יש להעלות לוח לשנה החדשה.");
    } catch (e) {}
  }
  Logger.log("זמנים ל-" + dateStr + (fromLuach ? " מהלוח" : " מ-Hebcal") + ": שקיעה " + shkia + ", סוזק\"ש " + sofZmanKsh);
  ...
  return { shabbatDate, shkia, tzet, sofZmanKsh,
           ...
           shacharitCapped, kshLabel, fromLuach };
}
...
function buildPlainMessage(z, parasha) {
  var msg = "*זמני תפילות לשבת פרשת " + parasha + "*\n"
    ...
    + "סוף זמן ק\"ש (" + z.kshLabel + "): *" + z.sofZmanKsh + "*\n"
...
function buildHtmlEmail(z, parasha) {
  var rowsHtml = ''
    ...
    + '<tr><td style="font-size:13px;color:#333;padding:5px 2px;border-bottom:1px dotted #ccc;">סוף זמן ק"ש (' + z.kshLabel + ')</td>'
